...
import { StyleSheet, View, Image, StatusBar, TouchableOpacity,Text,Dimensions } from 'react-native'
  ...
  return (
    ...
    {loading ? <View style={styles.container} />:
        ...
        <View style={styles.container} >
          ...
          <Swiper activeDotStyle={{backgroundColor:'#fff',width:10,height:10,borderRadius:10}} dotStyle={{backgroundColor:"rgba(255,255,255,0.8)",width:10,height:10,borderRadius:10}}style={styles.wrapper} showsPagination={true} loop={false} >
            ...
            <TouchableOpacity style={{position:'absolute',bottom:8,right:8}} onPress={async () =>{
